...
/**
 * @Description:
 * @ClassName: LevelTools
 * @Author: wujiangbo
 * @Date: 2020/7/6 0006 9:55
 * @Version: 1.1.0
 */
public class LevelTools {

    /* 
     * @Description: 根据积分查询对应的等级，共1-18等级
     * @MethodName: getLevelByPoint
     * @param:  [point]
     * @return: java.lang.String
     * @Author: wujiangbo
     * @Date: 2020/7/6 0006 10:27
     */ 
    ...
    /* 
     * @Description: 根据积分和性别获取等级对应的名称(区分男女)
     * @MethodName: getLevelNameByPoint
     * @param:  [point, sex]
     * @return: java.lang.String
     * @Author: wujiangbo
     * @Date: 2020/7/6 0006 10:26
     */ 
