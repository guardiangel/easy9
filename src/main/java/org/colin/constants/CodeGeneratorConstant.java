...
/**
 * @Description: CodeGeneratorConstant
 * @ClassName: CodeGeneratorConstant
 * @Author: wujiangbo(QQ : 1134135987)
 * @Date: 2020/5/21 12:06
 * @Version: 1.1.0
 */
public class CodeGeneratorConstant {

    public static final String BASE_PACKAGE = "org.colin";//生成代码所在的基础包名称，可根据自己公司的项目修改（注意：这个配置修改之后需要手工修改src目录项目默认的包路径，使其保持一致，不然会找不到类）
    ...
    public static final String MAPPER_INTERFACE_REFERENCE = BASE_PACKAGE + ".config.MapperConfig";//Mapper插件基础接口的完全限定名
}
