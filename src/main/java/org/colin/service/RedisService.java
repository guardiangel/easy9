...
public class RedisService {
    ...
    public Long getExpire(String key, TimeUnit unit) {
        if (null == key || null == unit) {
            throw new ServiceException(BaseResponseCode.DATA_ERROR.getCode(), "key or TomeUnit 不能为空");
        }
    ...
    public Boolean setifAbsen(String key, Object value, long time, TimeUnit unit) {
        if (null == key || null == value || null == unit) {
            throw new ServiceException(BaseResponseCode.DATA_ERROR.getCode(), "kkey、value、unit都不能为空");
        }
    ...
    public long incrby(String key, long increment) {
        if (null == key) {
            throw new ServiceException(BaseResponseCode.DATA_ERROR.getCode(), "key不能为空");
        }
